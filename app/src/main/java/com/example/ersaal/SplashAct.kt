...
import com.example.ersaal.core.ui.activities.SignInActivity
import com.example.ersaal.databinding.ActivitySplashBinding
            ...
            coroutineScope?.let {
                if (it.isActive) {
                    if (AppApplication.sessionManager.isLoggedIn) {
                        ...
                        val intent = Intent(this@SplashAct, SignInActivity::class.java)
                        startActivity(intent)
                        finish()
                    }
                }
